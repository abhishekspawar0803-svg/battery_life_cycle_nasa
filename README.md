...
![SOH Training Curve](images/soh-training.jpg)

### True vs Predicted SOH Scatter
![SOH Scatter Plot](images/soh-true-vs-pred-2.jpg)

### SOH Evaluation Across Cycles
![SOH Time-Series](images/soh-eval-4.jpg)

### Battery Degradation Profile Example
![Battery Profile Example](images/battery-data-example-3.jpg)
